...
import 'package:whats_app_clone/common/constants/firebase_collection_path.dart';
import 'package:whats_app_clone/features/user/data/data_sources/remote/user_remote_data_source.dart';
import 'package:whats_app_clone/features/user/data/models/user_model.dart';
...
class UserRemoteDataSourceImpl implements UserRemoteDataSource {
  ...
  Future<void> createUser(UserEntity user) async {
    final userCollection = fireStore.collection(FirebaseCollectionPath.users);
  ...
  Stream<List<UserEntity>> getSingleUser(String uid) {
    final userCollection = fireStore
        .collection(FirebaseCollectionPath.users)
